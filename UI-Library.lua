...
function redzlib:MakeWindow(Configs)
	...
	function Window:CloseBtn()
	    -- Fixed Windows:CloseBtn by @Yuna-ux
	...
	function Window:MakeTab(paste, Configs)
        ...
        function Tab:AddSlider(Configs)
            ...
            local function UpdateLabel(Value)
                local Number = tonumber(Value * Increase)
            ...
            local function UpdateValues()
                ...
                local NewValue = math.floor(SliderPos * ((Max * Increase) - (Min * Increase)) + (Min * Increase))
                UpdateLabel(NewValue / Increase)
            ...
            function SetSlider(NewValue)
                ...
                NewValue = math.clamp(NewValue, Min * Increase, Max * Increase)
            ...
            local function InitializeSlider()
                Default = math.clamp(Default, Min * Increase, Max * Increase)
                local SliderPos = (Default - (Min * Increase)) / ((Max * Increase) - (Min * Increase))
                
                CurrentValue = Default
                SliderIcon.Position = UDim2.fromScale(math.clamp(SliderPos, 0, 1), 0.5)
                UpdateLabel(Default / Increase)
            ...
            function Slider:Set(NewVal1, NewVal2)
                ...
                elseif type(NewVal1) == "number" then
                    SetSlider(NewVal1)
                    Funcs:FireCallback(Callback, NewVal1)
                end
            end
            ...
            function Slider:SetSlider(NewValue)
                SetSlider(NewValue)
            end
