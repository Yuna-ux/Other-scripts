...
local redzlib = {
	Themes = { -- Themes: Darker, Dark, Purple, Green [NEW].
    	Darker = {
...
local function UpdateAllElements()
    table.foreach(redzlib.Instances, function(_,Val)
        ...
        elseif Val.Type == "ScrollBar" then
            Val.Instance[GetColor(Val.Instance)] = Theme["Color Theme"]
        elseif Val.Type == "Button" then
            Val.Instance.BackgroundColor3 = Theme["Color Hub 2"]
        elseif Val.Type == "ToggleHolder" then
            Val.Instance.BackgroundColor3 = Theme["Color Stroke"]
        elseif Val.Type == "Toggle" then
            Val.Instance.BackgroundColor3 = Theme["Color Theme"]
        elseif Val.Type == "SliderBar" then
            Val.Instance.BackgroundColor3 = Theme["Color Stroke"]
        elseif Val.Type == "SliderIndicator" then
            Val.Instance.BackgroundColor3 = Theme["Color Theme"]
        elseif Val.Type == "DropdownHolder" then
            Val.Instance.BackgroundColor3 = Theme["Color Stroke"]
        end
    end)
end
